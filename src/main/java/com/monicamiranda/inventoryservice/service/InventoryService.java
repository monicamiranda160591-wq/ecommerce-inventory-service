package com.monicamiranda.inventoryservice.service;

import com.monicamiranda.inventoryservice.kafka.event.OrderPlacedEvent;
import com.monicamiranda.inventoryservice.kafka.event.InventoryUpdatedEvent;
import com.monicamiranda.inventoryservice.kafka.event.OrderCancelledEvent;
import com.monicamiranda.inventoryservice.kafka.event.OrderConfirmedEvent;
import com.monicamiranda.inventoryservice.kafka.producer.InventoryEventProducer;
import com.monicamiranda.inventoryservice.dto.InventoryItemRequest;
import com.monicamiranda.inventoryservice.dto.InventoryItemResponse;
import com.monicamiranda.inventoryservice.model.InventoryItem;
import com.monicamiranda.inventoryservice.repository.InventoryRepository;
...
public class InventoryService {
  ...
  public void processOrderPlaced(
    ...
    try {
      ...
      //6. Publicar InventoryUpdatedEvent
